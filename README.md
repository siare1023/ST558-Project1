...
```
    ...
    ## # A tibble: 1 x 13
    ##      id active captainHistory coachingHistory dateAwarded directoryUrl firstSeasonId generalManagerHisto… heroImageUrl mostRecentTeamId
    ##   <int> <lgl>  <lgl>          <lgl>           <lgl>       <chr>                <int> <lgl>                <lgl>                   <int>
    ## 1    39 TRUE   NA             NA              NA          ""                20212022 NA                   NA                         55
    ## # … with 3 more variables: retiredNumbersSummary <lgl>, teamAbbrev <chr>, teamFullName <chr>
...
```
    ...
    ##  4     4               1      19721973          22          3         309          897      983         53                  1       NA
...
```
    ...
    ## # … with 21 more rows, and 29 more variables: homeOvertimeLosses <int>, homeTies <int>, homeWins <int>, losses <int>,
...
```
    ...
    ##  9               1          2           NA    17      19921993          30        2195         6580     6250        413
    ## 10               1          2           NA    19      19271928           5        6516        19953    19980       1082
    ## # … with 21 more rows, and 35 more variables: homeOvertimeLosses <int>, homeTies <int>, homeWins <int>, losses <int>,
    ## #   overtimeLosses <int>, penaltyMinutes <int>, pointPctg <dbl>, points <int>, roadLosses <int>, roadOvertimeLosses <int>,
    ## #   roadTies <int>, roadWins <int>, shootoutLosses <int>, shootoutWins <int>, shutouts <int>, teamId <int>, teamName.x <chr>,
    ## #   ties <int>, abbreviation.x <chr>, wins <int>, name <chr>, abbreviation.y <chr>, teamName.y <chr>, venue.name <chr>,
